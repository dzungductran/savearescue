...
const Swipeout = createReactClass({
  ...
  _close: function() {
    ...
    this._callOnClose(this.state.openedRight ? 'right' : 'left');
    this.setState({
      openedRight: false,
      openedLeft: false,
      swiping: false,
  ...
  _callOnClose: function(direction) {
    if (this.props.onClose) this.props.onClose(this.props.sectionID, this.props.rowID, direction);
  },
